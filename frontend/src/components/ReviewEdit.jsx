...
import { getReviewById, updateReview } from "../api/api";
...
const ReviewEdit = () => {
  ...
  useEffect(() => {
    const fetchReview = async () => {
      try {
        ...
        setErrorMessage("Failed to fetch review details. Please try again.");
      }
    };
    fetchReview();
  }, [id]);
   
  // Handle edit book review field changes
  const handleChange = (e) => {
    const { name, value } = e.target;
    setFormData({ ...formData, [name]: value });
  };

  // Handle edit book review submission
  ...
  return (
    ...
    {/* Add form field for review text */}
      <div className="mb-3">
